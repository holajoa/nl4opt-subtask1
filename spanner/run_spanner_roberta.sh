...
wget -nc https://huggingface.co/${PRETRAINED}/raw/main/vocab.json
wget -nc https://huggingface.co/${PRETRAINED}/raw/main/merges.txt
mv vocab.json vocab/${PRETRAINED}/
mv merges.txt vocab/${PRETRAINED}/
