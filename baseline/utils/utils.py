...
conll_iob = {'B-LIMIT':0, 'I-LIMIT':1, 'B-CONST_DIR':2, 'I-CONST_DIR':3, 'B-VAR':4, 'I-VAR':5, 'B-PARAM':6, 'I-PARAM':7, 'B-OBJ_NAME':8, 'I-OBJ_NAME':9, 'B-OBJ_DIR':10, 'I-OBJ_DIR':11, 'O':12}
...
def get_reader(file_path, max_instances=-1, max_length=50, target_vocab=None, encoder_model='xlm-roberta-large'):
    if file_path is None:
        return None
    # Initialise Reader for CoNLL data
